...
def _time_cusparse(data, indices, indptr, shape, B, op, warmup, iters, layout="row"):
    ...
    try:
        ...
        return None, None, f"optional sparse reference unavailable: {exc}"
    try:
...
def main():
    ...
    parser.add_argument("--no-hipsparse", action="store_true", dest="no_cusparse", help="Disable direct hipSPARSE reference")
